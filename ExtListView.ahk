...
ExtListView_GetItemText(ByRef objLV, nRow, nCol) {
    ...
    NumPut( objLV.preadbuf,  LVITEM, 20                         ) ; pszText = Pointer to item text string.
    NumPut( objLV.szreadbuf, LVITEM, (A_PtrSize == 4) ? 24 : 32 ) ; cchTextMax = Number of TCHARs in the buffer.
